...
/**
 * This class provides a wrapper for network errors when making requests to Catalog API
 */
export class AgrimetricsError extends Error {
  /**
   * The response body
   */
